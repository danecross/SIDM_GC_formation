...
base_grid_size = gridsize = 256 # highest resolution displacement grid 
...
pspec_to_displacements(seed, powerfunc, ".", boxsize, base_grid_size, sigma8, omegab, omegaM, omegaL, H0,a,log)

disp_file = 'displ_grid_%d.npy'%gridsize
particle_file = 'particles_'+{True:'dmonly_',False:''}[dmonly]+'%d.dat'%gridsize
gadget_file = ('IC_%d_'%gridsize)+{True:'dmonly',False:''}[dmonly]+'.dat' 
